...
QUICKSIM <- function(parin, do_inits, param, init, parnames, data, n, idata, req, capturei, funs, nre) {
    .Call(`_mrgsolve_QUICKSIM`, parin, do_inits, param, init, parnames, data, n, idata, req, capturei, funs, nre)
}
