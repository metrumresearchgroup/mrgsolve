...
DEVTRAN <- function(parin, inpar, parnames, init, cmtnames, vars, capture, funs, data, idata, OMEGA, SIGMA, envir) {
...
DEVTRAN2 <- function(parin, inpar, parnames, init, cmtnames, vars, capture, funs, data, idata, OMEGA, SIGMA, envir) {
    .Call(`_mrgsolve_DEVTRAN2`, parin, inpar, parnames, init, cmtnames, vars, capture, funs, data, idata, OMEGA, SIGMA, envir)
}
...
TOUCH_FUNS <- function(lparam, linit, vars, Neta, Neps, capture, funs, envir) {
    .Call(`_mrgsolve_TOUCH_FUNS`, lparam, linit, vars, Neta, Neps, capture, funs, envir)
}
